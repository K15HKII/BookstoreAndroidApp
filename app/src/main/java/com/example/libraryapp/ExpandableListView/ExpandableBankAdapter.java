...
public class ExpandableBankAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        if(view == null){
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bank_group_view, viewGroup, false);
        }
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        if(view == null){
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bank_item_view, viewGroup, false);
        }
