...
public class arrived_view extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.arrived_view_fragment, container, false);
        rcvOrderView = view.findViewById(R.id.rcvArrivedOrderView);
        orderViewAdapter = new OrderViewAdapter(getListBook(),arrived_view.this.getContext());

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(arrived_view.this.getContext());
