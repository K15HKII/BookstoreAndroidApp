...
public class ShippingViewPageViewModel extends BaseViewModel<ShippingViewPageNavigator> implements Observable {
    ...
    private final MutableLiveData<List<OrderViewViewModel>> shippingOrderItemsLiveData = new MutableLiveData<>(
    ...
    public List<OrderViewViewModel> getShippingOrderItems() {
